...
class GoodsCategoryBrand(models.Model):
    ...
    desc = models.TextField(default='', max_length=200, verbose_name='品牌描绘', help_text='品牌描绘')
    image = models.ImageField(upload_to='brands/%Y/%m', max_length=200)
...
class Goods(models.Model):
    ...
    goods_desc = UEditorField(default='', filePath='goods/files', imagePath='goods/image', verbose_name='内容', width=600, height=1000)
    shop_free = models.BooleanField(default=True, verbose_name='是否承担运费')
